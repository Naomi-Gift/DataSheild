...
import { DATAMARKET_ABI, DATAMARKET_ADDRESS } from "@/lib/contracts";
            ...
            <div className="card-neon p-6 shadow-purple-glow">
              ...
              {step === 2 && (
                <div className="flex flex-col items-center py-6 gap-3">
                  ...
                  <span className="font-mono text-[12px] text-text-secondary">Confirm in wallet...</span>
                </div>
              )}
            </div>
          </Dialog.Content>
